...
import { Dialog, Popup, Tooltip, createSpinner, hideSpinner, showSpinner } from './ej2-popups.es2015.js';
import { DataManager, Query } from './ej2-data.es2015.js';
import { DropDownList } from './ej2-dropdowns.es2015.js';
import { FormValidator, NumericTextBox, TextBox } from './ej2-inputs.es2015.js';
...
class LayoutRender extends MobileLayout {
    ...
    getSwimlaneCards() {
        const swimlaneData = {};
        if (this.parent.swimlaneSettings.keyField) {
            this.kanbanRows.forEach((row) => swimlaneData[row.keyField] = this.parent.kanbanData.filter((obj) => this.columnKeys.indexOf(obj[this.parent.keyField].toString()) > -1 &&
