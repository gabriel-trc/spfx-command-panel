let createBatch, createItem, executeBatch, getFields, getItems, getItemById, getUserPermissions, updateItem, deleteItem, recycleItem
const siteUrl = '/'
export async function mvdInitializeModule() {
...
async function crudTest() {
    ...
    //createItem({ item, listGUID, listUrl, siteUrl, batch: currentBatch })
    //createItem({ item, listGUID, listUrl, siteUrl, batch: currentBatch })
    // getItemById({ getAttachments, id: 23, listGUID, listUrl, siteUrl, batch: currentBatch })
    //getItemById({ getAttachments, id: 22, listGUID, listUrl, siteUrl, batch: currentBatch })
    //deleteItem({ item: { ID: 23 }, listGUID, listUrl, siteUrl, batch: currentBatch })
    //recycleItem({ item: { ID: 24 }, listGUID, listUrl, siteUrl, batch: currentBatch })
    let camlQuery = '<ViewFields><FieldRef Name=\"ID\" /><FieldRef Name=\"Title\" /><FieldRef Name=\"Order\" /><FieldRef Name=\"Info\" /><FieldRef Name=\"Question\" /><FieldRef Name=\"Attachments\" /></ViewFields>'
    let camlQuery2 = "<View Scope=\"RecursiveAll\"><Query><Where><Eq><FieldRef Name=\"TestRelationField\" LookupId=\"True\"/><Value Type=\"Lookup\">6</Value></Eq></Where></Query><ViewFields><FieldRef Name=\"ID\" /><FieldRef Name=\"Title\" /><FieldRef Name=\"Order0\" /><FieldRef Name=\"Question\" /><FieldRef Name=\"Info\" /><FieldRef Name=\"Response\" /><FieldRef Name=\"Comments\" /><FieldRef Name=\"Attachments\" /><FieldRef Name=\"TestRelationFieldChecklistPreloa\" /></ViewFields></View>"
    getItems({ camlQuery, getAttachments: true, listUrl: 'Lists/TestRelationFieldChecklistPreload', siteUrl, batch: currentBatch })
    getItems({ camlQuery: '', getAttachments: true, listUrl: 'Lists/TestRelationField', siteUrl, batch: currentBatch })
